...
from ontcatowl.modules.utils_dataclass import get_list_gufo_classification, external_move_list_to_is_list
from ontcatowl.modules.utils_graph import get_subclasses, get_superclasses, get_all_subclasses
