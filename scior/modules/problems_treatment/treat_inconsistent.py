...
def report_inconsistency_case_in_rule(rule_code: str, ontology_dataclass: OntologyDataClass) -> None:
    """ Reports inconsistency case detected and interrupts the software execution. """

    LOGGER.error(f"Inconsistency detected in rule {rule_code} for class {ontology_dataclass.uri}. Program aborted.")
