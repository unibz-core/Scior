...
def set_interactively_class_as_gufo_type(ontology_dataclass, gufo_type):
    ...
    if option == "y":
        move_classification_to_is_type_list(ontology_dataclass_list,ontology_dataclass, gufo_type)
...
def set_type_for_class(ontology_dataclass):
    ...
    if selected_list == "is":
        ontology_dataclass
        move_classification_to_is_type_list(ontology_dataclass_list, selected_type)
    else:
