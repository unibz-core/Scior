"""OntCatOwl Module: Definition of data structures for OntCatOWL"""
...
if __name__ != "__main__":
    ...
    class OntologyClass:
        ...
        # TODO (@pedropaulofb): Create method for consistency checking. Checkings are:
        #   No same string must be in two lists at the same time.
        #   Sum of elements from all lists must be equal to X
